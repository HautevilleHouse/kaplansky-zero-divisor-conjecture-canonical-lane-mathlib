# Kaplansky Zero Divisor Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/kaplansky-zero-divisor-conjecture-canonical-lane-mathlib.git
cd kaplansky-zero-divisor-conjecture-canonical-lane-mathlib
lake exe
lake build
```
